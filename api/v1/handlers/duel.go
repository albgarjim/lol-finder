...
func GetDuelList(_w http.ResponseWriter, _r *http.Request) {
	...
	res, err := mdb.DBGetDuelList(params)
	if err != nil {
...
func GetDuelByID(_w http.ResponseWriter, _r *http.Request) {
	...
	res, err := mdb.DBGetDuelByID(params)
	if err != nil {
...
func DeleteDuelByID(_w http.ResponseWriter, _r *http.Request) {
	...
	res, err := mdb.DBDeleteDuelByID(params)
	if err != nil {
...
func CreateDuel(_w http.ResponseWriter, _r *http.Request) {
	...
	res, err := mdb.DBCreateDuel(params)
	if err != nil {
...
func UpdateDuelByID(_w http.ResponseWriter, _r *http.Request) {
	...
	res, err := mdb.DBUpdateDuelByID(params, u)
	if err != nil {
