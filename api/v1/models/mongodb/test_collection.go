...
func TestGetAllCollDB(_p *inp.URLParams) ([]*out.TestObj, error) {
	filter := bson.D{{}}
	res := []*out.TestObj{}
...
func TestGetCollByIdDB(_p *inp.URLParams) ([]*out.TestObj, error) {
...
func TestDeleteCollByIdDB(_p *inp.URLParams) (string, error) {
	objectId, err := GetSingleID((*_p)[inp.QColId])
	if err != nil{
		log.Println("Invalid id")
	}
...
func TestCreateCollByIdDB(_p *inp.URLParams) (string, error) {
	var res inp.TestObj
...
func TestUpdateCollByIdDB(_p *inp.URLParams, _u inp.TestObj) (string, error) {
	objectId, err := GetSingleID((*_p)[inp.QColId])
	if err != nil{
		log.Println("Invalid id")
	}
